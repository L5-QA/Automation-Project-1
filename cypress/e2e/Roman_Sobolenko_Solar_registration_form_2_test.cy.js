...
/*
Assignement 4 - Roman Sobolenko Solar
*/

describe("Section 1: Functional tests, created by: Roman Sobolenko Solar", () => {
  it("User can use only same both first and validation passwords", () => {
    cy.get("#username").type("roman");
    cy.get("#email").type("roman@solar.com");
    cy.get('[data-cy="name"]').type("roman");
    cy.get("#lastName").type("sol");
...
/*
Assignement 5 - Roman Sobolenko Solar
*/

describe("Section 2: Visual tests, created by: roman-solar", () => {
